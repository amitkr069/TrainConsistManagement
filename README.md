...
In this use case we are adding bogie by using LinkedHashSet


Goal is to -> Maintain insertion order while enforcing uniqueness.
...
##### Key Concepts Used in Use Case 5
